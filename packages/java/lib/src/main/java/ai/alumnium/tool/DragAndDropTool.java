...
public record DragAndDropTool(@ToolField(description = "Identifier (ID) of element to drag") int fromId,
                              @ToolField(description = "Identifier (ID) of element to drop onto") int toId) implements BaseTool {
    @Override
