...
public class Area {
    ...
    public Area(int id, String description, BaseDriver driver, BaseAccessibilityTree accessibilityTree, Map<String, Class<? extends BaseTool>> tools, HttpClient client) {
        this.id = id;
    ...
    public BaseAccessibilityTree accessibilityTree() { return accessibilityTree; }
    ...
    */
    ...
    public DoResult act(String goal) {
        ...
        for (String step : steps) {
            ActionResult actionResult = client.executeAction(goal, step, scopedTree().toStr(), driver.app());
    ...
    public Element find(String description) {
        FindElementResult response = client.findElement(
            description, scopedTree().toStr(), this.driver.app());
