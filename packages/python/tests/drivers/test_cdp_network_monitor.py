...
def test_ignores_in_memory_urls_chrome_never_reports_as_finished():
    monitor = CdpNetworkMonitor()

    monitor.process(
        "Network.requestWillBeSent",
        {"requestId": "worker", "type": "Other", "request": {"url": "blob:https://example.com/3bb82b96"}},
    )
    monitor.process(
        "Network.requestWillBeSent",
        {"requestId": "inline", "type": "Image", "request": {"url": "data:image/png;base64,iVBORw0KGgo="}},
    )
