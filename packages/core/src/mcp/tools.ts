...
/**
 * Tools available to the MCP's `do` command (matches handlers.ts extra_tools + common driver tools).
 */
export const MCPS_DO_TOOLS = [
  ClickTool,
  DragAndDropTool,
  ExecuteJavascriptTool,
  HoverTool,
    ...
    inputSchema: {
      ...
      properties: {
        ...
        statement: {
          type: "string",
          description:
            "Statement to verify (e.g., 'page title contains Dashboard')",
        },
        vision: {
          type: "boolean",
      ...
      properties: {
        ...
        for: {
          oneOf: [
            ...
            {
              type: "string",
              description: "Natural language condition to wait for",
            },
          ],
        ...
        timeout: {
          type: "integer",
          description:
            "Max seconds to wait for condition (default: 10, string only)",
          default: 10,
        },
      },
      required: ["for"],
